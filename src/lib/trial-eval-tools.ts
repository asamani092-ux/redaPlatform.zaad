...
const VERIFY_BY_PATH: Record<string, string> = {
  ...
  "/messages":
    "نافذة عائمة؛ تبويب دعوة/استبيان؛ حالة الإرسال؛ تصحيح الجوال؛ إعادة الإرسال؛ تأكيد إن كان خارج مستفيدي الاستبيان",
  "/trial-eval":
...
const EXTRA_TOOLS: TrialEvalTool[] = [
  ...
  },
  {
    ...
    path: "/messages",
    verify:
      "فتح النافذة؛ فلترة فشل الجوال/الدعوة/الاستبيان؛ حفظ جوال؛ إعادة دعوة؛ إعادة استبيان مع تأكيد إن خارج الفئة المستهدفة",
  },
  {
    id: "trial-eval-page",
