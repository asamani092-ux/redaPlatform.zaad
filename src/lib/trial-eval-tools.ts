...
const EXTRA_TOOLS: TrialEvalTool[] = [
  ...
  {
    id: "survey-multi",
    tool: "استبيانات متعددة حسب الجمهور",
    path: "/survey#admin",
    verify:
      "إنشاء أكثر من استبيان؛ اختيار جمهور (حضر فقط / استلم / دُعي ولم يحضر)؛ حفظ الكتالوج",
  },
  {
    id: "survey-questions",
    ...
    verify:
      "إضافة/إزالة أسئلة لكل استبيان؛ رابط خارجي اختياري؛ إرسال تلقائي بعد الصرف لجمهور «استلم» فقط؛ حفظ",
  },
  {
    id: "survey-responses",
  ...
  {
    id: "survey-broadcast",
    tool: "إرسال الاستبيان لجمهوره",
    path: "/survey#broadcast",
    verify:
      "بث الاستبيان المحدد لجمهوره فقط (حضر فقط / استلم / غائب مدعو)؛ بدون تكرار للمستفيد",
  },
  {
  ...
  },
  {
    ...
    path: "/messages",
    verify:
      "فتح النافذة؛ فلترة فشل الجوال/الدعوة/الاستبيان؛ حفظ جوال؛ إعادة دعوة؛ إعادة استبيان مع تأكيد إن خارج الجمهور",
  },
  {
    id: "trial-eval-page",
