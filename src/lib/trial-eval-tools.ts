...
const VERIFY_BY_PATH: Record<string, string> = {
  ...
  "/forgot-password":
    "إدخال الجوال؛ انتظار موافقة المدير خلال 5 دقائق؛ تعيين كلمة مرور جديدة والدخول بها",
  "/dashboard":
  ...
  "/invites":
    "دعوة وإرسال QR؛ زر «حالة واتساب» نافذة عائمة؛ تصحيح الجوال وإعادة الإرسال؛ طباعة المدعوين",
  "/attendance":
  ...
  "/inventory":
    "إضافة وتعديل أصناف؛ تفاصيل الصنف دون فتح حذف تلقائي؛ حذف الصنف (كمية صفر) بتأكيد مزدوج وسبب؛ تنبيه النفاد",
  "/reports":
    "عرض الملخص حسب المعرض؛ تصدير جداول وملف للطباعة؛ للمدير اختيار معرض دون تبديل النشط",
  "/survey":
    "إعداد الأسئلة؛ زر «حالة واتساب»؛ متابعة الردود؛ إعادة إرسال؛ لا إدخال يدوي",
  "/exhibitions":
...
const EXTRA_TOOLS: TrialEvalTool[] = [
  ...
  },
  {
    ...
    verify:
      "فتح المنشئ بجانب Excel؛ غلاف/خاتمة باسم الجهة؛ KPI/قمع/توزيع؛ معرض شواهد صورة/فيديو؛ تحرير الشواهد؛ بدء العرض ملء الشاشة",
  },
  {
  ...
  {
    id: "survey-multi",
    tool: "استبيانات متعددة حسب المستفيدين",
    path: "/survey#admin",
    verify:
      "إنشاء أكثر من استبيان؛ اختيار فئة المستفيدين (حضر فقط / استلم / دُعي ولم يحضر)؛ حفظ الكتالوج",
  },
  {
    id: "survey-questions",
    ...
    verify:
      "إضافة/إزالة أسئلة لكل استبيان؛ رابط خارجي اختياري؛ إرسال تلقائي بعد الصرف لفئة «استلم» فقط؛ حفظ",
  },
  {
    id: "survey-responses",
    tool: "ردود الاستبيان + طباعة",
    path: "/survey#responses",
    verify: "تصفية الردود حسب الاستبيان المختار؛ طباعة؛ لا إدخال يدوي للطاقم",
  },
  {
    id: "survey-broadcast",
    tool: "إرسال الاستبيان للمستفيدين",
    path: "/survey#broadcast",
    verify:
      "بث الاستبيان المحدد لمستفيديه فقط (حضر فقط / استلم / غائب مدعو)؛ بدون تكرار للمستفيد",
  },
  {
  ...
  {
    id: "messages-log-invite",
    tool: "حالة واتساب (الدعوات)",
    path: "/invites#whatsapp-log",
    verify:
      "فتح من زر داخل الدعوات؛ فلترة مضغوطة؛ حفظ جوال؛ إعادة إرسال الدعوة",
  },
  {
    id: "messages-log-survey",
    tool: "حالة واتساب (الاستبيان)",
    path: "/survey#whatsapp-log",
    verify:
      "فتح من زر داخل الاستبيان؛ فلترة مضغوطة؛ إعادة إرسال مع تأكيد إن خارج الفئة المستهدفة",
  },
  {
    id: "trial-eval-page",
